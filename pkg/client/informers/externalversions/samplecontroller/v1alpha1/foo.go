...
import (
	...
	samplecontroller_v1alpha1 "k8s.io/nginxx-controller/pkg/apis/samplecontroller/v1alpha1"
	versioned "k8s.io/nginxx-controller/pkg/client/clientset/versioned"
	internalinterfaces "k8s.io/nginxx-controller/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "k8s.io/nginxx-controller/pkg/client/listers/samplecontroller/v1alpha1"
)
